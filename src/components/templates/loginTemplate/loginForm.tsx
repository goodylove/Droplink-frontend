      ...
      <div className="flex flex-col ">
        ...
        <button className="flex justify-center w-full">
          <div
            ...
            className=" py-3 bg-white text-black font-sans font-normal relative  flex items-center justify-center gap-2"
          >
            <Image
              src="/google.png"
              alt="Google Logo"
              ...
              height={20}
            />
            <span className="text-sm font-normal"> Login with Google</span>
          </div>
        </button>
